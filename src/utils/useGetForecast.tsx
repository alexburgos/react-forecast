...
import { Currently, Minutely, Hourly, Daily, Alert, Flags } from '../interfaces/index';

const PROXY = 'https://cors-anywhere.herokuapp.com/';
const API_URL = 'https://api.darksky.net/forecast/f5eace3ac736c12a2aa36bef1d500399/37.8267,-122.4233'; //coordinates need to come from locator
